      ...
      <div className="flex justify-center items-center w-11/12 h-full">
        ...
        <div className='border border-forthColor lg:w-11/12 md:w-11/12 w-full text-white flex flex-col items-center h-[70%] bg-linkBgColor rounded-3xl'>
          ...
          <div className="w-full grid items-center justify-items-center h-2/4 tor_cont px-10 my-auto">
            <div className="first_container w-[40%] max-w-[200px] h-[90%]  border-8 relative">
              ...
              <User className="h-16 w-16 sm:h-24 sm:w-24 md:h-28 md:w-28 lg:h-32 lg:w-32 bg-linkBgColor absolute top-[50%] translate-y-[-50%] right-[-3.5rem] sm:right-[-4.5rem] text-center grid place-content-center" />
            </div>
            ...
            <div className="second_container w-[40%] max-w-[200px] h-[90%]  border-8 relative">
              ...
              <User className="h-16 w-16 sm:h-24 sm:w-24 md:h-28 md:w-28 lg:h-32 lg:w-32 bg-linkBgColor absolute top-[50%] left-[-3.5rem] sm:left-[-4.5rem] translate-y-[-50%] text-center grid place-content-center" />
            </div>
          </div>
        </div>
      </div>
