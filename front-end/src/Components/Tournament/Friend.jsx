...
export default function Friend({ icon = false, gameName, hidden = false, PlayerName }) {
    ...
    return (<div className="flex flex-row w-[100%] items-center">
        <img src="lshail.png" className={`rounded-full md:w-[60px] md:h-[60px] object-fit border-[2px] xsm:w-[60px] xsm:[60px] sm:w-[60px] sm:h-[60px] ${icon ? 'border-green-600' : 'border-red-600'}`} />
