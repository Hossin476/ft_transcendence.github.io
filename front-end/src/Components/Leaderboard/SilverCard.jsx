...
function SilverCard() {
    return (
        <div className='px-4 rounded-3xl my-auto text-center card_silver'>
            ...
            <img src='/silver.jpg' alt='avatar' className='avatar' />
            ...
            <button className='text-white rounded-xl button_silver md:text-md sm:text-xs lg:text-lg'>
                View Profile
            </button>
        </div>
    )
