      ...
      <div className="bg-[#21162C] border border-gray-400 rounded-lg p-6">
        <div className="space-y-6">
          <div className="space-y-4">
            <span className="text-white">{t("Paddle Color")}</span>
          ...
          <div className="space-y-4">
            <span className="text-white">{t("Ball Color")}</span>
