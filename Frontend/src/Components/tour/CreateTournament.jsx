    ...
    return (
        <div className=" h-[10rem] w-[100%] flex items-center justify-center">
            <div className="w-[90%] h-[5rem] flex bg-secondaryColor items-center relative justify-between border-[2px] border-thirdColor rounded-md px-4">
                <input className="h-[2.5rem] w-[80%] rounded-lg outline-none  focus:border-transparent pl-2" type="text" placeholder={t("create your tournament")} name="tournament" onChange={(e)=>setTournamentName(e.target.value)} value = {tournamentName}/>
