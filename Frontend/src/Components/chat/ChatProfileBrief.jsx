        ...
        <div className="flex flex-col justify-center  items-center mt-2">
            ...
            <div className="m-5 flex justify-center">
                <div className="grid grid-rows-2 gap-3 place-items-center">
                    ...
                    <button onClick={()=>handlBlock()}  type="button" className="rounded-full w-32 py-2 px-8 border border-1 border-white bg-white bg-opacity-40 lg:text-lg text-white">Block</button>
                </div>
            </div>
        </div>
    )
                ...
                { 
                    ...
                    ?(blocker.id === user.user_id
                        ?<div className="flex justify-center"> 
                            <button onClick={handleUnblock}  className = "px-4 py-2 border rounded-full text-lg">unblock </button>
                         </div>: "")
