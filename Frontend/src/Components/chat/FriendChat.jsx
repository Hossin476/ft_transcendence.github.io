  ...
  return (
    <>
      <span
        ...
        className={`flex   truncate h-24 justify-between text-shadow-2xl my-2 items-center p-3 ${
          contacts.id === selected ? "bg-gradient-to-r from-linkColor" : ""
        } hover:bg-white hover:bg-opacity-20`}
        style={{ cursor: "pointer" }}
      >
        <div className="flex gap-4 text-wrap truncate  items-center">
          ...
          <div>
            <p className="text-base truncate ">{contacts.user.username}</p>
            <p className="text-sm   truncate max-w-[14rem] font-thin opacity-70">
